      ...
      <ul class="Contact__social">
        ...
        <li class="Contact__social-item">
          <a href="https://twitter.com/onedevstudioweb/" target="_blank">
            <svg aria-labelledby="twitter-icon" role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" width="46" height="46" fill="#5fc193">
        ...
        <li class="Contact__social-item">
          <a href="https://github.com/onedevstudio/" target="_blank">
            <svg aria-labelledby="github-icon" role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" width="46" height="46" fill="#5fc193">
